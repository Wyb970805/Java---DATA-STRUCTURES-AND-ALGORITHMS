...
public interface HeapInterface<S> {
    ...
    public S popIndex(); // Return the result of specific index and pull out from the stack
    public S popTop(); // Return the result of last in and pull out from the stack
    public S peekTop(); // Peek the most last put in one
    public S peekIndex(); // Peek the specific index in array of stack
    ...
    public int count(); // Count the size of the array in stack
}
